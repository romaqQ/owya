...
contract KernelFactory is AdminLessERC1967Factory, Ownable {
    ...
    mapping(address => bool) public isStrategyProvider;
    ...
    function setStrategyProvider(address _strategyAccount, bool _allow) external onlyOwner {
        isStrategyProvider[_strategyAccount] = _allow;
    }
}